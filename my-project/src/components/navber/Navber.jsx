  ...
  <nav className="app-header navbar navbar-expand bg-body"> {/*begin::Container*/}
    <div className="container-fluid"> {/*begin::Start Navbar Links*/}
      <ul className="navbar-nav">
        <li className="nav-item"> <Nablink className="nav-link" data-lte-toggle="sidebar" to="#" role="button"> <i className="bi bi-list" /> </Nablink> </li>
        <li className="nav-item d-none d-md-block"> <Nablink to="#" className="nav-link">Home</Nablink> </li>
